...
function initEditorSections() {
  ...
  const ordered = ["Dashboard", "Diseno", "Idioma", "SEO", "Empresa", "Ubicacion", "Multimedia", "Tipologias", "Memoria de calidades", "Dossier PDF", "Contacto", "Redes sociales", "Biblioteca", "Historial", "Acciones"];
